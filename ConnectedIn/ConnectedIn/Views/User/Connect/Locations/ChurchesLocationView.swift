            ...
            .overlay(alignment: .topTrailing) {
                Button {
                    ...
                    Image(systemName: isHybridMap ? "map.fill" : "map")
                        .font(.system(size: 18))
                        .frame(width: 36, height: 36) // Fixed frame
                        .background(.thinMaterial)
                        .clipShape(Circle())
                }
                .padding(.top, 170) // Adjust for navigation bar
                .padding(.trailing, 10)
            }
...
private struct BottomSheetView: View {
    ...
    let onDismiss: () -> Void
    @State private var showingChurchDetail = false
    ...
    var body: some View {
        VStack(spacing: 20) {
            ...
            HStack(spacing: 12) {
                ...
                // Church Detail Button
                Button {
                    showingChurchDetail = true
                } label: {
        ...
        .cornerRadius(15)
        .sheet(isPresented: $showingChurchDetail) {
            if let church = church {
                NavigationView {
                    ChurchDetailView(church: church, useCloseButton: true)
